            ...
            <div className="flex flex-col justify-center items-center gap-5">
                ...
                <div className="card w-11/12 m-auto rounded-md bg-base-100 shadow-xl">
                    <div className="card-body justify-center items-center gap-3 text-center">
                        ...
                        <p className="text-sm italic">{clicked ? <div><p className="border bg-warning w-full rounded-md p-1 text-xs">Save {plan[0].savings}%</p> <p>Compared To Monthly</p></div> : ''}</p>
